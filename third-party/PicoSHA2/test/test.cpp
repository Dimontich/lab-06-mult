...
bool is_same_bytes(InIter1 first1, InIter1 last1, InIter2 first2,
        InIter2 last2){
...
const std::pair<std::string, std::string> sample_message_list[sample_size] = {
 ...
 mess_and_hash("For this , this 63-byte string will be used as input data",
 "f08a78cbbaee082b052ae0708f32fa1e50c5c421aa772ba5dbb406a2ea6be342"),
 mess_and_hash("abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq",
 "248d6a61d20638b8e5c026930c3e6039a33ce45964ff2167f6ecedd419db06c1"),
 mess_and_hash("This is exactly 64 bytes long, not  the terminating byte",
 ...
 mess_and_hash("This is exactly 64 bytes long, not countingthe terminating b",
...
void test(){
    for (std::size_t i = 0; i < sample_size; ++i){
        ...
        std::cout << "src_str: " << src_str  << " size: "
        << src_str.length() << std::endl;
        ...
        hex_string_to_bytes(ans_hex_str, ans);
        {
            ...
            picosha2::hash256(src_str.begin(),
                    src_str.end(), hash.begin(), hash.end());
        ...
        }
        {
            ...
            picosha2::hash256_hex_string(src_str.begin(),
                    src_str.end(), hash_hex_str);
        ...
        {
            std::list<unsigned char> hash(picosha2::k_digest_size);
            picosha2::hash256(src_vect.data(),
                    src_vect.data()+src_vect.size(),
                              hash.begin(), hash.end());
            PICOSHA2_CHECK_EQUAL_BYTES(ans, hash);
        }
        {
        ...
        }
        {
            ...
            std::vector<unsigned char> hash(picosha2::k_digest_size);
            picosha2::hash256(src.begin(), src.end(), hash.begin(),
                    hash.end());
            PICOSHA2_CHECK_EQUAL_BYTES(ans, hash);
        }
    }
